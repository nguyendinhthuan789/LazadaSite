...
public class Scripts_RegisterPage extends PageSetupBase {
	...
	@Test
	public void Testcase001_Register_Email_Exist() throws Exception {
		// Start Object
		...
		Assert.assertTrue(objRegEmailExist.getErrorMessage().contains("Customer email already exist"));
		ExcelHandle ObjExel=new ExcelHandle();
		ObjExel.setCellData("Register", 11, 1, "FAILED");
	}
